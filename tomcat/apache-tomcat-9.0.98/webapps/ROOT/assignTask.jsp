...
<%
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        try {
            String insertTask = "INSERT INTO tasks_group (Subject, Description, Start_Date, Due_Date, Status_ID, Group_ID, User_ID) VALUES (?, ?, NOW(), ?, 1, ?, ?)";
    ...
    try {
        String memberQuery = "SELECT u.User_ID, u.Username FROM user u INNER JOIN group_members gm ON u.User_ID = gm.User_ID WHERE gm.Group_ID = ?";
        ...
        <select name="assignee" required>
            <%
                while (members.next()) {
                    ...
                    String name = members.getString("Username");
            %>
